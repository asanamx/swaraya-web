...
export const Hero = () => {
  ...
  return (
    <section
      className="relative min-h-screen overflow-hidden with-grain"
    ...
    >
      ...
      <div
        ...
        style={{
          height: 120,
          background:
            'linear-gradient(to bottom, transparent 0%, rgba(17, 17, 20,0) 40%, rgba(255, 255, 255,0.04) 70%, rgba(255, 255, 255,0.18) 100%)',
        }}
      />
    </section>
  );
