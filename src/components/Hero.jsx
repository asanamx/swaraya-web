  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 80% 60% at 75% 35%, rgba(84,104,214,0.22) 0%, transparent 60%), radial-gradient(ellipse 70% 50% at 15% 80%, rgba(44,62,128,0.14) 0%, transparent 60%)',
          filter: 'blur(20px)',
        }}
      />
        ...
        >
          ...
          >
            <div className="flex flex-wrap items-center gap-x-10 gap-y-6 md:gap-x-14">
              ...
              {/* Claude */}
              <div className="flex items-center gap-2 transition-all duration-300 hover:opacity-100" style={{ opacity: 0.55, color: '#C8CCDC' }}
                onMouseEnter={(e) => { e.currentTarget.style.opacity = '1'; e.currentTarget.style.color = '#5468D6'; }}
                onMouseLeave={(e) => { e.currentTarget.style.opacity = '0.55'; e.currentTarget.style.color = '#C8CCDC'; }}
                title="Claude"
              >
              ...
              {/* OpenAI */}
              <div className="flex items-center gap-2 transition-all duration-300" style={{ opacity: 0.55, color: '#C8CCDC' }}
                onMouseEnter={(e) => { e.currentTarget.style.opacity = '1'; e.currentTarget.style.color = '#5468D6'; }}
                onMouseLeave={(e) => { e.currentTarget.style.opacity = '0.55'; e.currentTarget.style.color = '#C8CCDC'; }}
                title="OpenAI"
              >
              ...
              {/* OpenClaw */}
              <div className="transition-all duration-300" style={{ opacity: 0.55, color: '#C8CCDC' }}
                onMouseEnter={(e) => { e.currentTarget.style.opacity = '1'; e.currentTarget.style.color = '#5468D6'; }}
                onMouseLeave={(e) => { e.currentTarget.style.opacity = '0.55'; e.currentTarget.style.color = '#C8CCDC'; }}
                title="OpenClaw"
              >
