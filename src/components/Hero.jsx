      ...
      >
        ...
        >
          <defs>
            <radialGradient id="ringFade" cx="50%" cy="50%" r="50%">
              <stop offset="0%" stopColor="#2C3E80" stopOpacity="0.55" />
              <stop offset="100%" stopColor="#2C3E80" stopOpacity="0" />
            </radialGradient>
          </defs>
          ...
          <g style={{ transformOrigin: '300px 300px', animation: 'orbitDash 22s linear infinite' }}>
            <circle cx="300" cy="10" r="3.5" fill="#2C3E80" />
            <circle cx="300" cy="10" r="6" fill="#2C3E80" opacity="0.3" />
          </g>
          <g style={{ transformOrigin: '300px 300px', animation: 'orbitDash 14s linear infinite reverse' }}>
            <circle cx="300" cy="90" r="2.5" fill="#2C3E80" />
            <circle cx="300" cy="90" r="5" fill="#2C3E80" opacity="0.25" />
          </g>
          <g style={{ transformOrigin: '300px 300px', animation: 'orbitDash 9s linear infinite' }}>
            <circle cx="300" cy="170" r="2" fill="#2C3E80" />
            <circle cx="300" cy="170" r="4" fill="#2C3E80" opacity="0.3" />
          </g>

          {/* Dashed sweep on outer ring (suggests "scanning") */}
          <circle
            cx="300" cy="300" r="290"
            stroke="#2C3E80" strokeWidth="1" strokeDasharray="80 1740"
          ...
          <g transform="translate(258 258) scale(1.3)" stroke="#2C3E80" strokeWidth="3.2" strokeLinecap="round">
          ...
          <g stroke="#2C3E80" strokeWidth="1" opacity="0.42">
        ...
        <div
          style={{
            ...
            color: 'rgba(44,62,128,0.55)', fontFamily: "'Inter', sans-serif",
          }}
        >
          axis · 5/5
        </div>
