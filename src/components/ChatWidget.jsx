  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed bottom-[26px] right-[26px] z-50 w-11 h-11 rounded-xl bg-[#709cb3] text-white shadow-lg shadow-[#709cb3]/30 flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-xl hover:shadow-[#709cb3]/40 ${isOpen ? 'scale-0 opacity-0' : 'scale-100 opacity-100'}`}
        ...
        <div className="bg-[#0A0C10] rounded-2xl shadow-2xl shadow-black/50 border border-[rgba(255,255,255,0.06)] overflow-hidden flex flex-col h-[520px] max-h-[calc(100vh-6rem)]">
          ...
          <div className="px-5 py-4 bg-gradient-to-r from-[#0C1016] to-[#0A0C10] border-b border-[rgba(255,255,255,0.04)] flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-full bg-[#709cb3] flex items-center justify-center">
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4 scrollbar-thin scrollbar-thumb-[rgba(255,255,255,0.1)] scrollbar-track-transparent">
              ...
              >
                ...
                <div className={`w-7 h-7 rounded-full flex-shrink-0 flex items-center justify-center ${
                  ...
                  {msg.role === 'user' 
                    ...
                    : <Bot className="w-3.5 h-3.5 text-[#709cb3]" />
                  }
                </div>
                ...
                <div className={`max-w-[75%] px-4 py-3 rounded-2xl text-sm leading-relaxed ${
                  msg.role === 'user'
                    ? 'bg-[#709cb3] text-white rounded-tr-md'
            ...
            {isLoading && (
              <div className="flex gap-3">
                <div className="w-7 h-7 rounded-full bg-[#709cb3]/20 flex items-center justify-center">
                  <Bot className="w-3.5 h-3.5 text-[#709cb3]" />
                </div>
          ...
          <form onSubmit={sendMessage} className="p-4 border-t border-[rgba(255,255,255,0.04)]">
            <div className="flex gap-2">
              <input
                ...
                disabled={isLoading}
                className="flex-1 px-4 py-3 bg-[rgba(255,255,255,0.04)] border border-[rgba(255,255,255,0.06)] rounded-xl text-sm text-[#F4F6F9] placeholder-[#5D6878] focus:outline-none focus:border-[#709cb3]/50 transition-colors disabled:opacity-50"
                data-testid="chat-input"
              />
              <button
                type="submit"
                disabled={!input.trim() || isLoading}
                className="w-11 h-11 rounded-xl bg-[#709cb3] text-white flex items-center justify-center transition-all hover:bg-[#5d8a9e] disabled:opacity-50 disabled:cursor-not-allowed"
