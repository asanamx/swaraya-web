...
const PrivacyPolicy = () => {
  return (
    <div className="min-h-screen bg-[#F5F2EC]" data-testid="privacy-policy-page">
      <Navbar />
      ...
      <main className="pt-24 pb-20 md:pt-32 md:pb-28">
        <div className="container-main">
          ...
          <div className="mb-12 md:mb-16">
            <p className="label-accent text-[#2C3E80] mb-4">Legal</p>
          ...
          <div className="max-w-3xl space-y-10 text-[#3C4654]">
            <section className="space-y-4">
              <h2 className="text-xl md:text-2xl font-light text-[#0E0F11]">1. Información General</h2>
            ...
            <section className="space-y-4">
              <h2 className="text-xl md:text-2xl font-light text-[#0E0F11]">2. Información que Recopilamos</h2>
              <p className="leading-relaxed">Podemos recopilar los siguientes tipos de información:</p>
              <ul className="list-disc list-inside space-y-2 ml-4">
                <li><strong className="text-[#0E0F11]">Información de contacto:</strong> nombre, dirección de correo electrónico, número de teléfono y empresa.</li>
                <li><strong className="text-[#0E0F11]">Información técnica:</strong> dirección IP, tipo de navegador, dispositivo utilizado y páginas visitadas.</li>
                <li><strong className="text-[#0E0F11]">Información de comunicación:</strong> contenido de los mensajes enviados a través de nuestro formulario de contacto o asistente de chat.</li>
                <li><strong className="text-[#0E0F11]">Información de uso:</strong> cómo interactúa con nuestro sitio web y servicios.</li>
              </ul>
            </section>

            <section className="space-y-4">
              <h2 className="text-xl md:text-2xl font-light text-[#0E0F11]">3. Uso de la Información</h2>
            ...
            <section className="space-y-4">
              <h2 className="text-xl md:text-2xl font-light text-[#0E0F11]">4. Compartir Información</h2>
              <p className="leading-relaxed">
            ...
            <section className="space-y-4">
              <h2 className="text-xl md:text-2xl font-light text-[#0E0F11]">5. Seguridad de los Datos</h2>
              <p className="leading-relaxed">
            ...
            <section className="space-y-4">
              <h2 className="text-xl md:text-2xl font-light text-[#0E0F11]">6. Cookies y Tecnologías Similares</h2>
              <p className="leading-relaxed">
            ...
            <section className="space-y-4">
              <h2 className="text-xl md:text-2xl font-light text-[#0E0F11]">7. Sus Derechos</h2>
            ...
            <section className="space-y-4">
              <h2 className="text-xl md:text-2xl font-light text-[#0E0F11]">8. Retención de Datos</h2>
              <p className="leading-relaxed">
            ...
            <section className="space-y-4">
              <h2 className="text-xl md:text-2xl font-light text-[#0E0F11]">9. Cambios a este Aviso</h2>
              <p className="leading-relaxed">
            ...
            <section className="space-y-4">
              <h2 className="text-xl md:text-2xl font-light text-[#0E0F11]">10. Contacto</h2>
              <p className="leading-relaxed">
